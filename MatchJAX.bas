...
Public Sub JaxMatchResults()
    ...
    For Each resultfile In rsFSOFile
        ...
        If InStr(resultfile, "~") < 1 And InStr(resultfile, ".xlsx") > 0 And InStr(resultfile, "~$") < 1 And InStr(resultfile, "desktop.ini") < 1 Then
            ...
            resultRange1 = Split(Cells(1, TargetName).Address, "$")(1) & 20
...
Function JAXCheckFormatting(rwb) As Boolean
    ...
    For Each items In rwb.Sheets(1).range("A16: AZ16")
    ...
    For Each cell In resultBook.Sheets(1).range("A17", "AZ17").Cells
        ...
        For i = 1 To 50
            ...
            ElseIf jaxExtraTests(i) = cell Then
                ...
                resultBook.Sheets(1).Cells(18, replaceColumnIndex + 3) = jaxExtraStypes(i) & " GT"
...
Sub deletePCR2(rwb, resultLocation)
    ...
    pcr2range1 = Split(Cells(1, pcr2Column).Address, "$")(1) & 20
...
Public Function checkCompleteGenotype(rwb, gtColumn) As Boolean
    ...
    gtrange1 = Split(Cells(1, gtColumn).Address, "$")(1) & 20
...
Public Sub setUpResultBooks(wb, resultTextLocation)
    ...
    If Not resultTextLocation = 0 Then
        ...
        wb.Worksheets(1).Cells(18, resultTextLocation + 2) = "SEQ CAG 1"
        wb.Worksheets(1).Cells(18, resultTextLocation + 3) = "GT"
...
Public Function SearchResultColumnTestJax(wb) As Integer
    ...
    For Each field In wb.Sheets(1).range("A17", "Z17")        'The Template rows has to start at 19 for Jax
        If field = "" Then
            columnIndex = columnIndex + 1
        Else
            columnIndex = columnIndex + 1
