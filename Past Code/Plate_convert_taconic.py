...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr  8 22:20:37 2022
...
summary_info = final_df.loc[0]# infor of each plate
summary_info = summary_info.iloc[:,12:]
summary_info["comments"] = None
summary_info = summary_info.sort_values(by=['CAG protocal', 'Laragen_Protocal', 'Project'], ascending=False)
summary_info = summary_info.reset_index(drop=True)
#wirte into excel fine
writer = pd.ExcelWriter('Taconic_allinOne.xlsx')
final_df.to_excel(writer, 'Sheet1')
summary_info.to_excel(writer, 'Sheet2')
